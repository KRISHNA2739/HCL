...
public class CustomerController {
	...
	dao.updateCustomerPurchaseCapacity(1,500);
	System.out.println("updated.....");
		
		Customer customer1=dao.getSelectedCustomerByid(1).orElseThrow(()-> new CustomerNotFoundException("Customer not found"));
	System.out.println(customer1);
		
	Customer customer2=dao.getSelectedCustomerByname("baj").orElseThrow(()-> new CustomerNotFoundException("Customer not found"));
